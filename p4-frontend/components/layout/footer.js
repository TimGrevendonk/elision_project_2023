import { getSocialMediaLinks } from "@/data/querries";
      ...
      <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3  text-center">
          <div>
            ...
            <ul className=" text-gray-400 flex flex-col items-start">
              <li>
                <Link
                  ...
                  <span>
                    {links.fields.facebook.content[0].content[0].value}
                  </span>
